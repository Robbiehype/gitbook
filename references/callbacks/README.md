...
{% hint style="info" %}
For coins which have longer processing time, we have instant deposit functionality. notifications on `depositReceivedCallbackUrl` endpoint. This allows the merchant to credit the deposit of the user, while transfer is still _confirming_ on the blockchain. The maximum allowance currently for instant deposits is set to 2000 EUR.
{% endhint %}
